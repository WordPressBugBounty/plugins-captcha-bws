...
if ( ! function_exists( 'cptch_get_default_options' ) ) {
	...
	function cptch_get_default_options() {
		...
		$default_options = array(
			...
			'title'                         => '',
			'required_symbol'               => '*',
			'text_start_slide'              => __( 'Slide to verify', 'captcha-bws' ),
			'text_end_slide'                => __( 'Verification passed', 'captcha-bws' ),
			...
			'fsp_enable'                    => 0,
			'fsp_length'                    => 12,
			'fsp_error_message'             => __( 'Password must be at least {min_length} characters long and include uppercase and lowercase letters, numbers and symbols.', 'captcha-bws' ),
		);
